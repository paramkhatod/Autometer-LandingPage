    ...
    let dataReview = [
        {
            id: 1,
            user: '/desaiM.png',
            review: 'My students love using Autometer for their projects. It teaches them valuable automation skills while being completely free.',
            name: 'Yogita K. Desai'
        },
        {
            id: 2,
    ...
    return (
        <div className="my-20 lg:my-36 w-full xl:w-container mx-auto text-center">
            <div className="title4">
                ...
                <p className="mt-3 w-3/4 mx-auto text-slate-400 text-base">See what our users are saying</p>
            </div>
